...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Banner.file_attached'
        db.add_column('banners_banner', 'file_attached',
                      self.gf('django.db.models.fields.files.FileField')(default=1, max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Banner.file_attached'
        db.delete_column('banners_banner', 'file_attached')
    ...
    models = {
        'banners.banner': {
            ...
            'file_attached': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True'}),
