...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Service.manager'
        db.alter_column('work_service', 'manager_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Manager'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Service.manager'
        raise RuntimeError("Cannot reverse this migration. 'Service.manager' and its values cannot be restored.")
