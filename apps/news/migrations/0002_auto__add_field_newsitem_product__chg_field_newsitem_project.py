...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsItem.product'
        db.add_column('news_newsitem', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['work.Product'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'NewsItem.project'
        db.alter_column('news_newsitem', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'], null=True))

    def backwards(self, orm):
        # Deleting field 'NewsItem.product'
        db.delete_column('news_newsitem', 'product_id')


        # User chose to not deal with backwards NULL issues for 'NewsItem.project'
        raise RuntimeError("Cannot reverse this migration. 'NewsItem.project' and its values cannot be restored.")
