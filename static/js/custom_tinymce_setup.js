...
if (typeof tinyMCE != 'undefined') {
    tinyMCE.init({
        ...
        theme_advanced_buttons1: "bold,italic,|,link,unlink,|,image,|,media,charmap,|,code,|,table,|,bullist,numlist,outdent,indent,blockquote,|,undo,redo,|,formatselect,|,search,replace,|,fullscreen,",
        ...
        extended_valid_elements: 'javascript|iframe'
    });
}
